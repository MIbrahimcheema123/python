...
FONT_SIZE = 72
pygame.init()
background_image = pygame.transform.scale(pygame.image.load("C:\\Users\\HP\\OneDrive\\Desktop\\New folder\\python\\lessons\\lesson 36\\bg.jpg"),(SCREEN_WIDTH , SCREEN_HEIGHT))
