...
C = input(print("enter the value of C:"))
D = input(print("enter the value of D:"))
...
tree1 = int(input(print("enter the length of tree1:")))
tree2 = int(input(print("enter the length of tree2:")))
tree3 = int(input(print("enter the length of tree3:")))
tree4 = int(input(print("enter the length of tree4:")))
tree5 = int(input(print("enter the length of tree5:")))
...
amount = int(input(print("enter the amount of money you want to widraw:")))
note_1 = amount//100
...
tem = int(input(print("enter the temperatue of taday:")))
if tem > 40 :
